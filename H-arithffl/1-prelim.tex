...
\prg{Weil, geometric interpretation of ad{\`e}les}
...
\prg{Grothendieck, sheaf-to-function correspondence}
...
\prg{Brylinski, geometric Radon transformation}
...
\ssc{Shtukas and Drinfeld modules}

Ref: for Shtukas, use~\cite{Varshavsky2004}; for Drinfeld modules, use~\cite{Papikian2023}; more comprehensively, use~\cite{Thakur2004}; for affine Grassmannians, use~\cite{BL1994Conformal}???




\ssc{Automorphic objects}
