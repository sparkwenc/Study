...
\begin{document}
\ifmain
    \title{\tbf{Deformation theory}}
    \author{Cong Wen, 02/24}
    \makeatletter
    ...
    \maketitle
    \begin{abstract}
        Notes\footnote{Last updated on January 01, 2000} on deformation theory.
    \end{abstract}
...
Ref:~\cite{Illusie1971,Illusie1972,Hartshorne2010}.
