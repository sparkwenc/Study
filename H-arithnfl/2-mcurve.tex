...
\ssc{On modular curves}
	...
	\begin{itm}
		...
		\item \cite{GZ1986,GK1993,ARGOS-intersection}: quadratic forms
	\end{itm}

\sss{On Iwasawa theory}

Consider two routes to it, the classical one as in \cite{Ribet1976Modular,Wiles1980,MW1984} for $\bQ$ and \cite{Wiles1990Iwasawa} for totally real fields; and the one by Rubin, \cite{Washington1997} for $\bQ$, and \cite{Rubin1991} for imaginary quadratic fields.
...
\sss{Density conjecture}

\red{TODO:} Do some Andr{\'e}-Oort

\sss{The basis problem}
\begin{qst}
...
For proof of the Gross-Zagier formula~\cite{GZ1986}.

\prg{Setup and the main identities}
...
\prg{Derivative of Rankin $L$-series}
...
\prg{Computation of local heights}
