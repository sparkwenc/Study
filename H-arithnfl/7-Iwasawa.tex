...
\end{cmt}
	...
	Let $\rho:\bZ_{p}\dS{\Gal(\oL{\bQ}/\bQ)}\ar R^{(\ift)}$ be the unique continuous ring homomorphism extending $\Gal(\oL{\bQ}/\bQ)\ar\bZ_{p,a}\xT$.

	Say a $R_{\km}^{(\ift)}$-module equipped with a commuting action of $\Gal(\oL{\bQ}/\bQ)$ is yoked if its $\Gal(\oL{\bQ}/\bQ)$-structure is compatible with $\rho$.
